...
export class playerWorldDB_Table extends WorldDB_Table {
    ...
    getData(key: "landCreating"): {value: LandCreateJSON, score: number} | null;
    ...
    setData(key: "landCreating", value: LandCreateJSON, score?: number): void;
